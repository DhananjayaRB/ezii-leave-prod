...
const fetchEmployeesFromAPI = async (filters?: FilterState): Promise<Employee[]> => {
  try {
    ...
    const response = await fetch('https://apiv1.resolvepay.in/organization/employees?page=1&pageSize=0', {
      method: 'POST',
      headers: {
...
const fetchWorkerTypes = async (): Promise<WorkerType[]> => {
  try {
    ...
    const response = await fetch('https://apiv1.resolvepay.in/organization/customer/worker-type-list', {
      method: 'GET',
      headers: {
        'Authorization': `Bearer ${jwtToken}`,
      },
...
const fetchAttributes = async (): Promise<Attribute[]> => {
  try {
    ...
    const response = await fetch('https://apiv1.resolvepay.in/organization/attribute-list', {
      method: 'GET',
      headers: {
        'Authorization': `Bearer ${jwtToken}`,
      },
...
const fetchSubAttributes = async (attributeId: string): Promise<SubAttribute[]> => {
  try {
    ...
    const response = await fetch(`https://apiv1.resolvepay.in/organization/attribute-details/${attributeId}`, {
      method: 'GET',
      headers: {
        'Authorization': `Bearer ${jwtToken}`,
      },
